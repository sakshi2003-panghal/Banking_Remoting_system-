...
import sqlite3
from tkinter import messagebox, Frame, Canvas
...
lbl_title=Label(win,text="Bank Management System",bg="powder blue",font=('Arial',55,'bold','underline'))
...
def login_screen():
    ...
    def login_db():
        ...
        if(acn=="" or pwd==""):
            ...
            if(tup==None):
                ...
                frm.destroy()
                welcome_screen()
    lbl_acn=Label(frm,text="Account No",bg='white',font=('Arial',20,'bold'))
    ...
    lbl_pass=Label(frm,text="Password",bg='white',font=('Arial',20,'bold'))
...
def newuser_screen():
    ...
    btn_back=Button(frm,text="back",command=back,font=('Arial',20,'bold'),bd=5,bg="white")
    btn_back.place(relx=0,rely=0)
    
    lbl_name=Label(frm,text="Name",bg='white',font=('Arial',20,'bold'))
    ...
    lbl_email=Label(frm,text="Email",bg='white',font=('Arial',20,'bold'))
    ...
    lbl_mob=Label(frm,text="Mob",bg='white',font=('Arial',20,'bold'))
    lbl_mob.place(relx=.3,rely=.5)
    
    e_mob=Entry(frm,font=('Arial',20,'bold'),bd=5)
    e_mob.place(relx=.45,rely=.5)
    
    lbl_type=Label(frm,text="ACN Type",bg='white',font=('Arial',20,'bold'))
    ...
    btn_open=Button(frm,text="open",command=openacn_db,font=('Arial',20,'bold'),bd=5,bg="pink")
    btn_open.place(relx=.45,rely=.8)
    
    btn_reset=Button(frm,text="reset",font=('Arial',20,'bold'),bd=5,bg="pink")
...
def forgotpass_screen():
    ...
    btn_back=Button(frm,text="back",command=back,font=('Arial',20,'bold'),bd=5,bg="pink")
    btn_back.place(relx=0,rely=0)
    
    lbl_acn=Label(frm,text="ACN",bg='white',font=('Arial',20,'bold'))
    ...
    btn_get=Button(frm,text="get",command=get_db,font=('Arial',20,'bold'),bd=5,bg="pink")
